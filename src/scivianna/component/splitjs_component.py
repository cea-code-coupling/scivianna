...
from panel_splitjs import HSplit as SplitJSVertical
from panel_splitjs import VSplit as SplitJSHorizontal
...
if __name__ == "__main__":
    ...
    split_react = SplitJSHorizontal(
        bokeh_plot_top,
        SplitJSVertical(
            bokeh_plot_left, bokeh_plot_right, sizing_mode="stretch_both", sizes=(30, 70)
        ),
        sizing_mode="stretch_both",
    )
    split_react.show()
